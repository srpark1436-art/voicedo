      ...
      <header className="bg-white sticky top-0 z-10 shadow-[0_1px_0_rgba(0,0,0,0.06)]">
        ...
        <div className="px-5 py-3.5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-violet-600 rounded-lg flex items-center justify-center shadow-sm flex-shrink-0">
            ...
            <h1 className="text-[22px] font-bold text-slate-900 tracking-tight">VoiceDo</h1>
          </div>
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="w-10 h-10 rounded-lg flex items-center justify-center transition-colors bg-slate-100 text-slate-500 hover:bg-indigo-50 hover:text-indigo-500"
              aria-label="할일 추가"
            >
            ...
            <div className="relative">
              <button
                ...
                className="w-10 h-10 rounded-full overflow-hidden border-2 border-slate-200 hover:border-slate-300 transition-colors flex-shrink-0"
                aria-label="프로필 메뉴"
              >
